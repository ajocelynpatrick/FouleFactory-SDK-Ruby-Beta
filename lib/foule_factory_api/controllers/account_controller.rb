...
module FouleFactoryApi
  class AccountController < BaseController
    ...
    def get_account_validate_transaction(transaction_id, 
                                         accept_language = 'fr')
    ...
    # @param [String] accept_language Optional parameter: Example: fr
    # @return Mixed response from the API call
    def create_account_pay_in(model, 
                              accept_language = 'fr')
      # the base uri for api requests
      _query_builder = Configuration.base_uri.dup
      ...
      # Create the HttpRequest object for the call
      _request = @http_client.post _query_url, headers: _headers, parameters: model.to_json, username: Configuration.basic_auth_user_name, password: Configuration.basic_auth_password
    ...
    # @param [String] accept_language Optional parameter: Example: fr
    # @return Mixed response from the API call
    def create_account_create_account(acc, 
                                      accept_language = 'fr')
      # the base uri for api requests
      _query_builder = Configuration.base_uri.dup
      ...
      # Create the HttpRequest object for the call
      _request = @http_client.post _query_url, headers: _headers, parameters: acc.to_json, username: Configuration.basic_auth_user_name, password: Configuration.basic_auth_password
