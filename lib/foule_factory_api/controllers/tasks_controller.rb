...
module FouleFactoryApi
  class TasksController < BaseController
    ...
    def update_tasks_validate(task, 
                              accept_language = 'fr')
      ...
      _request = @http_client.put _query_url, headers: _headers, parameters: task.to_json, username: Configuration.basic_auth_user_name, password: Configuration.basic_auth_password
    ...
    # @param [String] accept_language Optional parameter: Example: fr
    # @return Mixed response from the API call
    def get_tasks_get_answer_choices(id, 
                                     accept_language = 'fr')
      # the base uri for api requests
      _query_builder = Configuration.base_uri.dup
    ...
    # @param [String] accept_language Optional parameter: Example: fr
    # @return Mixed response from the API call
    def get_tasks_get_answer_texts(id, 
                                   accept_language = 'fr')
      # the base uri for api requests
      _query_builder = Configuration.base_uri.dup
